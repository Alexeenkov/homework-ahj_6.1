...
export default class Trello {
  constructor() {
    ...
    this.offsetCardClickX = null; // Сюда записывается позиция курсора по оси X в момент клика по перетаскиваемой карточке;
    this.offsetCardClickY = null; // Сюда записывается позиция курсора по оси Y в момент клика по перетаскиваемой карточке;
